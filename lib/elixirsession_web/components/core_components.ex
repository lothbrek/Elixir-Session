defmodule ElixirsessionWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElixirsessionWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElixirsessionWeb.Gettext, "errors", msg, opts)
    end
  end
